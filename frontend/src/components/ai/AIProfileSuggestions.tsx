...
import { Sparkles, Wand2, RefreshCw, Check, Copy, ChevronDown } from "lucide-react";
...
export function AIProfileSuggestions({ suggestions, onApply, onRefresh, isLoading }: AISuggestionsProps) {
...
export function generateSampleSuggestions(): ProfileSuggestion[] {
    return [
        {
            id: "1",
            type: "headline",
