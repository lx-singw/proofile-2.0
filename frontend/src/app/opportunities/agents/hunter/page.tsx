        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {['Product Manager', 'Senior PM', 'Director of Product'].map(role => (
                                    <span key={role} className="px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-full text-sm">
                                        {role} ×
                                    </span>
                                ))}
                            </div>
                ...
                <div className="mt-6 flex gap-3">
                    <button className="flex-1 py-3 bg-emerald-600 text-white font-medium rounded-xl hover:bg-emerald-700">
                        Save Settings
                    </button>
